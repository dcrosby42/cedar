...
describe "Cedar::Resources::ResourceLoader" do
  ...
  describe "#load_image" do
    ...
    it "throws for missing image" do
      expect(lambda do resource_loader.load_image "zoinks" end).to raise_error(/Cannot load_image "zoinks"/)
    end
  end
  ...
  describe "#load_file" do
    ...
    it "throws for missing file" do
      expect(lambda do resource_loader.load_file "zoinks" end).to raise_error(/Cannot load_file "zoinks"/)
    end
  end
  ...
  describe "#load_data" do
    ...
    it "throws for missing file" do
      expect(lambda do resource_loader.load_data "zoinks" end).to raise_error(/Cannot load_data "zoinks"/)
    end
  end
end
